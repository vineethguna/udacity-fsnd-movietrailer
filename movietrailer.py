...
def main():
    ...
    add_parser.add_argument('-t', '--title', dest='title', help='Title of the movie')
    add_parser.add_argument('-i', '--art-url', dest='art_url', help='Box art url of the movie')
    add_parser.add_argument('-y', '--trailer-url', dest='trailer_url', help='Youtube trailer url of the movie')
